          ...
          <div className={styles.ctaWrapper}>
            ...
            {isAuthenticated ? (
                ...
                <>
                    ...
                    {/* Botón Mi Espacio */}
                    <Link className={styles.ctaLoginBtn(theme)} to={(user?.rol === 'admin' || user?.rol === 'superadmin') ? '/dashboard/admin' : '/dashboard/cliente'}>
          ...
          {isAuthenticated ? (
            <>
              <Link
                ...
                to={(user?.rol === 'admin' || user?.rol === 'superadmin') ? '/dashboard/admin' : '/dashboard/cliente'}
                onClick={closeMenu}
              >
                Mi Espacio
              </Link>

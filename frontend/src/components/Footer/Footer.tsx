    ...
    <footer className={styles.footer(theme)}>
      <div className={styles.container}>
        ...
        <div className={styles.socialWrapper}>
          <a className={styles.socialLink(theme)} href="https://www.linkedin.com/in/mario-valiente-1239521a3/" aria-label="LinkedIn"
          ...
          <a className={styles.socialLink(theme)} href="https://github.com/MarioValiente-Giraldo" aria-label="GitHub"
          target="_blank" rel="noopener noreferrer">
